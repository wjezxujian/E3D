...
namespace E3D
{
	...
	public:
		...
		//创建地形
		EMesh* createTerrian(const EString& rawFileName, const EString& heightMapFileName, EFloat uTitle = 1, EFloat vTitle = 1, EFloat blockSize = 5.0f);
